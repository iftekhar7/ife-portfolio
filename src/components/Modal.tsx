      ...
      <div className="modal-wrapper sliding-modal sliding-modal-transition">
        <div
          className={`modal-dialog ${
            props.modalType === "delete" ? "modal-sm" : props.modalWidth
            ...
            <div className="modal-content">
              <div
                className={`modal-header ${
                  props.modalType === "delete" ? "modal-header-delete" : ""
                }`}
              >
                <h5 className="truncate">{props.modalHeading}</h5>
                <p className="truncate">{props.subheading}</p>
              </div>
                  ...
                  <div className="delete-modal-content">
                    ...
                    <div className="confirm-box">
                      ...
                      <input
                        ...
                        onChange={(event) =>
                          onDeleteInputChange && onDeleteInputChange(event)
                        }
                      />
                    </div>
                  </div>
